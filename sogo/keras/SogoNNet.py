...
class SogoNNet():
    ...
    def __init__(self, game, args):
        ...
        for i in range(1,6):
            ...
            branch4x4 = conv2d_bn(branch4x4, 64, 4, 4,name=f'mix{i}_branch4x4_2')

            branch3x3dbl = conv2d_bn(x, 64, 1, 1,name=f'mix{i}_branch3x3dbl_1')
            branch3x3dbl = conv2d_bn(branch3x3dbl, 96, 3, 3,name=f'mix{i}_branch3x3dbl_2')
            branch3x3dbl = conv2d_bn(branch3x3dbl, 96, 3, 3,name=f'mix{i}_branch3x3dbl_3')
